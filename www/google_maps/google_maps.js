 ...
 */
  ...
  * googleMaps.getObjectByID(selector) and using an id/class to retrieve it.
  ...
  *
  * var map = googleMaps.getObjectByID('#myMap');
...
(function() {
	 ...
	 *
	 *	@exports getObjectByID(selector)
	...
	document.addEventListener('deviceready', deferred, false);
	...
	*/
     ...
     */
	googleMaps.getObjectByID = function(mapSelector) {
		var map = null;
    ...
    /**
     * Similar to googleMaps.getObjectByID except it will return an array of markers that are used
